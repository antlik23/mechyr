...
export type ResponseData = SuccessResponseJSON<UpdatedPaths['/api/v1/oab_forms']['get']>;
export type QueryResponseProperties = Simplify<Response<ResponseData>>;
export type OabForm = ResponseData['oab_forms'][number];

export type DetailResponseData = SuccessResponseJSON<UpdatedPaths['/api/v1/oab_forms/{id}']['get']>;
