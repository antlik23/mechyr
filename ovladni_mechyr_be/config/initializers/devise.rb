...
Devise.setup do |config|
  ...
  config.mailer_sender = if Rails.application.credentials.smtp.present?
                           Rails.application.credentials.smtp[:from]
                         else
                           'test@example.com'
                         end
  ...
  # config.pepper = 'a5ce1aab8e952820f1ad395f5da49bc8d52a035d77c24b472b2ccf7219cb8e5a7d1b799731f83bbe2a93a21a57b2e30a6c0a08ce0670ce0bdf6b57868bd63cf0'
